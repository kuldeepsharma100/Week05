package com.ioprogramming.csvdatahandling.advanceproblems.databasetocsv;
...
public class DatabaseToCSV {
    ...
    private static final String DB_PASSWORD = "My2002Sql*@1";

    public static void main(String[] args) {
        String csvFilePath = "src/main/java/com/ioprogramming/csvdatahandling/advanceproblems/databasetocsv/employees.csv"; // Output CSV file
